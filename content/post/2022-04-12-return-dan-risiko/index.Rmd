...
Dengan menggunakan komputer kita tidak perlu lagi menghitung secara manual return, risiko, SD, Var, Cov dll. Berikut sebagai ilustrasi bagaimana membandingkan kinerja beberapa saham dengan menggunakan software [R](https://www.r-project.org/). Data harga saham harian diunduh dari [Yahoo Finance](finance.yahoo.com). Saham yang akan dibandingkan adalah saham BNI, PT Waskita Karya, dan PT Aneka Tambang. 
